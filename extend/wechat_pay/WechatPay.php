...
class WechatPay
{
    ...
    {
        $this->appid = !empty(config('wechat_appid')) ? config('wechat_appid') : 'wxe0deba39657a483b';
        $this->mch_id = !empty(config('wechat_direct_mchid')) ? config('wechat_direct_mchid') : '1536014871';
        $this->partnerKey = !empty(config('wechat_direct_partnerkey')) ? config('wechat_direct_partnerkey') : '123sdsdfsdfw234234223dfd7234fdf4';
        $this->ssl_cer = EXTEND_PATH.'wechat_pay/cert/apiclient_cert.pem';
        $this->ssl_key = EXTEND_PATH.'wechat_pay/cert/apiclient_key.pem';
    }
