(function() {
	$.fn.weixinAudio = function(options) {
		...
		function Plugin($context) {
			...
			this.$Audio = $context.children('#mediaAudio');
...
//                                self.updateTotalTime();
			...
			updateTotalTime: function() {
				...
				self.$audio_length.removeClass('aui-iconfont aui-icon-refresh').text(audioTime);
			},
			//改变音频源
			changeSrc:function(src,callback){
				...
				self.Audio.src = src;
                        ...
                        setLoadding:function(){
                            var self = this;
                            self.$audio_length.addClass('aui-iconfont aui-icon-refresh');
                        },
                        //加载完成之后
                        complateAudio:function(){
                             var self = this;
