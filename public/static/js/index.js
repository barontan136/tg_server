...
layui.config({
	...
	function lockPage(){
		layer.open({
			...
			content : '	<div class="admin-header-lock" id="lock-box">'+
							'<div class="admin-header-lock-img"><img src="'+CS.headimg+'"/></div>'+
							'<div class="admin-header-lock-name" id="lockUserName">'+CS.admin_name+'</div>'+
							'<div class="input_btn">'+
	...
	$("body").on("click","#unlock",function(){
		if($(this).siblings(".admin-header-lock-input").val() == ''){
			...
			$(this).siblings(".admin-header-lock-input").focus();
                      ...
                      var lock_password = $(this).siblings(".admin-header-lock-input").val();
                       $.ajax({
                        url: CS.lock_url,
                        type: 'post',
	...
	if(window.sessionStorage.getItem("menu") != null){
		...
		curmenu = window.sessionStorage.getItem("curmenu");
                ...
                var cur = $('.navBar').find('a[data-url*="'+JSON.parse(curmenu).href+'"]');
                cur.parent().addClass('layui-this');
