...
//    'dispatch_error_tmpl'   => THINK_PATH . 'tpl' . DS . 'dispatch_jump.tpl',
    ...
    //犒赏支付回调通知地址
    'reward_notify_url' => sprintf('%s://%s/index.php/wxpay/Reward/notify', $_SERVER['REQUEST_SCHEME'], $_SERVER['HTTP_HOST']),
    'share_url' => sprintf('%s://%s', $_SERVER['REQUEST_SCHEME'], $_SERVER['HTTP_HOST']),
];
